    ...
    <section className="mb-10">
      ...
      <div className="bg-card border rounded-lg p-6 mb-6">
        <p className="text-muted-foreground leading-relaxed mb-4">
          Follow these steps to deploy the Cluster Fallback Management service
          on TrueFoundry.
        </p>
        ...
        <div className="bg-muted/50 rounded-md p-4 mb-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm ml-6">
            ...
            <li>
              The Docker image URL or GitHub repository URL for this service
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="ml-9 space-y-3">
            <p className="text-muted-foreground text-sm">
              A <strong className="text-foreground">Service</strong> is a
              running application on TrueFoundry. We'll create one to host the
              Cluster Fallback Management app.
            </p>
            <ol className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  Select your source:{' '}
                  <strong className="text-foreground">Docker Image</strong>{' '}
                  (paste image URL) or{' '}
                  <strong className="text-foreground">GitHub</strong> (connect
                  your repository)
                </span>
              </li>
              <li className="flex gap-2">
        ...
        <div className="mb-8">
          ...
          <div className="ml-9 space-y-3">
            <p className="text-muted-foreground text-sm">
              A <strong className="text-foreground">Volume</strong> is
              persistent storage that keeps your data safe even if the service
              restarts. We need this to store fallback configurations.
            </p>
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-md p-3 text-sm">
              ...
              <p className="text-muted-foreground">
                Without a volume, your configurations will be lost every time
            ...
            <ol className="space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <strong className="text-foreground">Volumes</strong>
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  Click{' '}
                  <strong className="text-foreground">Create Volume</strong>
                </span>
              </li>
              <li className="flex gap-2">
              ...
              <li className="flex gap-2">
                ...
                <span>
                  Set size to at least{' '}
                  <code className="bg-muted px-1.5 py-0.5 rounded text-xs">
                    1 GB
                  </code>{' '}
                  (configurations are small, so this is plenty)
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-primary font-medium shrink-0">2.5</span>
                <span>
                  Click <strong className="text-foreground">Create</strong>
                </span>
              </li>
            </ol>
            <a
        ...
        <div className="mb-8">
          ...
          <div className="ml-9 space-y-3">
            <p className="text-muted-foreground text-sm">
              Now we'll connect the volume to your service so it can store
              configuration data.
            </p>
            <ol className="space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <strong className="text-foreground">Configuration</strong> or{' '}
                  <strong className="text-foreground">Edit</strong> page
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-primary font-medium shrink-0">3.2</span>
                <span>
                  Find the <strong className="text-foreground">Volumes</strong>{' '}
                  or <strong className="text-foreground">Storage</strong>{' '}
                  section
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  Click <strong className="text-foreground">Add Volume</strong>{' '}
                  and select the volume you created
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  Set the{' '}
                  <strong className="text-foreground">Mount Path</strong> to:
                  <code className="bg-muted px-1.5 py-0.5 rounded text-xs ml-1">
                    /app/data
                  </code>
                </span>
              </li>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-md p-3 text-sm mt-3">
              ...
              <p className="text-muted-foreground">
                The mount path{' '}
                <code className="bg-muted px-1 rounded">/app/data</code> is
                where the service looks for its configuration files. Make sure
                to use this exact path!
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="ml-9 space-y-3">
            <p className="text-muted-foreground text-sm">
              Environment variables are settings that tell the service how to
              behave. You'll need to add these in the service configuration.
            </p>
            <ol className="space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2">
                <span className="text-primary font-medium shrink-0">4.1</span>
                <span>
                  In your service configuration, find the{' '}
              ...
              <li className="flex gap-2">
                ...
                <span>
                  Add each variable listed in the{' '}
                  <strong className="text-foreground">
                    Environment Variables
                  </strong>{' '}
                  section below
              ...
              <li className="flex gap-2">
                ...
                <span>
                  For sensitive values (like API tokens), use TrueFoundry's{' '}
                  <strong className="text-foreground">Secrets</strong> feature
                </span>
              </li>
              <li className="flex gap-2">
            ...
            <p className="text-muted-foreground text-sm mt-3">
              👇 See the complete list of environment variables in the next
              section.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 text-sm">
          ...
          <div className="space-y-1">
            ...
            <code className="bg-muted px-2 py-1 rounded block">
              /app/data/cluster-fallback-configs.json
            </code>
          </div>
        </div>
      </div>
